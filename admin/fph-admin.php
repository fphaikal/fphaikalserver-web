                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['session_username'] ?></span>
                    ...
                    <div class="container-fluid">
                        <table class="table table-bordered">
                            ...
                            <?php
                                ...
                                include '../koneksi.php';
                                $no = 1;
                                $tampil = mysqli_query($koneksi, "SELECT * FROM kris ORDER BY id_kris DESC");
